...
function buscarMovimentos($conn, $filtroDataInicio = null, $filtroDataFinal = null, $limit = 1000)
{
  $where = [];
            ...
            <tr>
              ...
              <td>
                ...
                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                  data-bs-target="#editMovimentoModal"
                  data-movimento='<?php echo json_encode($movimento, JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP); ?>'
                  onclick="openEditMovimentoModal(this)">
                  Editar
                </button>
            ...
            <div class="form-row">
              <div class="col">
                <select name="limit" class="form-control">
                  ...
                  <option value="1000" <?php echo $limit == 1000 ? 'selected' : '' ?>>1000 Registros</option>
                </select>
              </div>
              <div class="col">
